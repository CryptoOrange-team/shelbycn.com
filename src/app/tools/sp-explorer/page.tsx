  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-5 py-8 sm:py-12">
      ...
      <div className="flex gap-0.5 mb-5 border-b border-border overflow-x-auto">
        ...
        <a href="/tools/sp-explorer/map" className="shrink-0 px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold border-b-2 border-transparent text-text3 hover:text-text2 transition-colors">🗺 地图</a>
      </div>
